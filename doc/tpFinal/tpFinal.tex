...
\begin{itemize}
	...
	\item Utilizaremos el \textit{Contractile Particle Model}\footfullcite{parisi}
...
\begin{itemize}
	\item \textit{Steering Behavior}\footfullcite{ai}
...
\begin{frame}
\Wider{
\frametitle{Gráfico de la distancia recorrida promedio}
\framesubtitle{Para distintos valores de obstáculos fijos}
\begin{figure}[H]
	\centering
...
\begin{frame}
\Wider{
\frametitle{Gráfico del tiempo promedio de simulación}
\framesubtitle{Para distintos valores de $W_{s}$ y $W_{v}$}
\begin{figure}[H]
	\centering
